...
function Timer() {
  ...
  return (
    <div className='saleTime'>
        <div className='whatsNew'><div className='redBar'></div><h5 className='newsContext'>Today's</h5></div>
        <div className='timerInfo'>Days      Hours      Minutes      Seconds</div>
        <h1 className='timer'>Flash Sales: <div className='clock'>{timer}</div></h1>
